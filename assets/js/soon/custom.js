...
(function($) {
    ...
    **/
    var launch = new Date(2014, 11, 06, 00, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('I swear I will get this done soon');
        }
        else{
            ...
            message.html('In the meantime, enjoy these awesome photos from my adventures');
        }
    }
})(jQuery);
/******************************************************************************************************************************
...
(function($){
    $(document).ready( function(){
        ...
        var launchDay = new Date(2014, 11, 06, 00, 00);
        $('#mobileTimer').countdown({
            until: launchDay
        });
